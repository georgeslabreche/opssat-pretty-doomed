...
# Processes all noisy samples through Wiener filtering

VALIDATION_DIR="samples/validation/noizeus"
OUTPUT_DIR="output/validation/noizeus/wiener"
BINARY="./build/wiener_filtering"

echo "=== Batch Validation - Wiener Filtering ==="
echo ""
