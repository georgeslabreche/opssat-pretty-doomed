...
Post-run debriefings are written in markdown under `debriefings/run-NN-YYYY-MM-DD/`, matching the data folder naming. Each debriefing is self-contained: its README is the debriefing itself, and any figures live alongside it.
