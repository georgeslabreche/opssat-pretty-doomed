...
// Extended range: dark greys -> browns -> maroon -> blood -> red -> pink
// clang-format off
static const uint8_t DOOM_FIRE[][3] = {
    {0x00,0x00,0x00}, {0x07,0x07,0x07}, {0x0b,0x0b,0x0b}, // black/dark grey
    {0x13,0x13,0x13}, {0x1b,0x1b,0x1b}, {0x0b,0x07,0x00}, // grey to dark brown
    {0x17,0x0f,0x07}, {0x1f,0x17,0x0b}, {0x2b,0x13,0x07}, // dark brown
    {0x37,0x0b,0x00}, {0x43,0x00,0x00}, {0x4f,0x00,0x00}, // brown to dark maroon
    ...
    {0xff,0x3f,0x3f}, {0xff,0x5f,0x5f}, {0xff,0x7b,0x7b}, // pink/light red
};
// clang-format on
